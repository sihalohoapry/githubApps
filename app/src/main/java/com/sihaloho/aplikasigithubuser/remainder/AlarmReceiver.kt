...
import com.sihaloho.aplikasigithubuser.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setOneTimeAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(context, "Pengigat Sudah Dibuat", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context, type: String) {
        ...
        Toast.makeText(context, "Pengigat Dibatalkan", Toast.LENGTH_SHORT).show()
    }
